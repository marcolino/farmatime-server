...
const apiName = "ACME";
const appName = "acme";
const appDescription = "A powerful web app, easily customizable";
const dir = "ltr";
const charset = "UTF-8";
...
const configBase = {
  ...
  email: {
    dryrun: !production, // if true, do not really send emails, use virtual send
    subject: {
      prefix: apiName,
    },
    administration: {
  ...
  app: { // this section will be copied to client project as "config.json" file
    ...
    ui: {
      ...
      defaultThemeBackgroundColor: "#e4e4e7",
      footerHeight: "1.5rem",
