...
const configBase = {
  ...
  email: {
    ...
    fromName: "FarmaTime",
    administration: {
      to: process.env.FARMATIME_ADMIN_EMAIL,
      toName: "FarmaTime admin",
    },
    support: {
      to: process.env.FARMATIME_SUPPORT_EMAIL,
  ...
  envRequiredVariables: [
    ...
    "FARMATIME_ADMIN_EMAIL",
    "FARMATIME_ADMIN_PASSWORD",
    "FARMATIME_POSTA_EMAIL",
    "FARMATIME_POSTA_PASSWORD",
    "FARMATIME_SUPPORT_EMAIL",
    "FARMATIME_SUPPORT_PASSWORD",
  ],
  app: { // this section will be copied to client project as "config.json" file
    ...
    auth: {
      ...
      refreshTokenExpirationDontRememberMeSeconds: 60 * 60, // 1 hour TTL: time after refresh token expires, and user must sign in again (in case user did check DontRememberMe)
