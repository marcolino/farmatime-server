...
const containerized = (__dirname.startsWith("/app")); // if current dir name starts with "/" ("/app"), we are inside a container
...
const configBase = {
  ...
  app: { // this section will be copied to client project as "config.json" file
    ...
    maintenance: true, // to disable site for maintenance
    mode: {
      production,
      development,
      test,
