...
console.log("Google Client ID:", process.env.GOOGLE_OAUTH_CLIENT_ID.slice(-10));
console.log("Google Secret Secret:", process.env.GOOGLE_OAUTH_CLIENT_SECRET.slice(-10));
